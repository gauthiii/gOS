...
Development is tracked as a sequence of phases. v1.0 (Phases 0–11) is documented in [version1/PROJECT_PLAN.md](version1/PROJECT_PLAN.md), each with its own detailed write-up (`version1/phase0.md` through `version1/phase11.md`). Past v1.0, [version1/phase-patch.md](version1/phase-patch.md) documents a follow-up patch (a real hang fix plus unlabeled-button UX fix), and [version1/audit.md](version1/audit.md) is a standalone, read-only flaw audit of the whole v1.0 kernel (24 ranked findings). [project-plan-2.md](version2/project-plan-2.md) is the v2 plan: **Track A** audit fixes + **Track B** new features (both complete), plus **Track C** OS internals, **Track D** desktop/storage, and **Track E** apps — see [phase12.md](version2/phase12.md)–[phase14.md](version2/phase14.md) for Track A, [phase15.md](version2/phase15.md)–[phase17.md](version2/phase17.md) for Track B, and [phase18.md](version2/phase18.md)/[phase19.md](version2/phase19.md) for Tracks C–E so far.
...
- **`wait` is poll-style, not truly blocking**: `SYS_WAITPID` (Phase 20) returns `-1` until the target process is a zombie, rather than descheduling the caller until the child exits — a documented scope cut (see [phase20.md](version2/phase20.md)) since a real blocking wait needs a wait-queue this phase didn't build.
...
- **Known-safe-by-convention, not by construction**: `fm.c`'s double-click file identity is tracked by row index, not filename — safe today only because every listing-mutating code path calls `fm_refresh()` first (see Finding #24 in [phase14.md](version2/phase14.md)); documented as an explicit invariant rather than hardened against.
...
- **Audit 2 Medium/Low cleanup (v3 Track A, Phase 27):** closes out Track A, fixing all 10 Medium and 7 Low findings. The Calculator now handles chained negative results correctly and flags arithmetic overflow instead of silently wrapping. The heap allocator now coalesces free blocks backward as well as forward, reducing fragmentation. `GOS.CFG` is now checksummed on load, and a corrupted or invalid File Manager window geometry falls back to sane defaults instead of being applied verbatim. Plus 11 smaller fixes: right-clicking the taskbar no longer opens the wallpaper menu, re-selecting the active wallpaper skips a redundant reload, `cd` and `run` give clear errors instead of silently truncating/misbehaving, the desktop menu is dismissed by a window click, and more. A real regression was found and fixed during testing: an early version of one reentrancy-guard fix broke the window stress test, corrected before this phase closed - see [phase27.md](phase27.md)
...
**Real arrow cursor + BMP wallpaper on the desktop** ([phase15.md](version2/phase15.md), Milestones 15.1/15.3)
...
**Cursor renders above windows** ([phase15.md](version2/phase15.md), Milestone 15.1)
...
**Cursor renders above the taskbar** ([phase15.md](version2/phase15.md), Milestone 15.1)
...
**Gradient fallback when no wallpaper file is present** ([phase15.md](version2/phase15.md), Milestone 15.2)
...
**Graceful fallback on a corrupted wallpaper file** ([phase15.md](version2/phase15.md), Milestone 15.3)
...
**Typing unsaved text, then minimizing the window** ([phase16.md](version2/phase16.md), Milestone 16.2)
...
**Minimized: window fully hidden, state preserved** ([phase16.md](version2/phase16.md), Milestone 16.2)
...
**Restored via the taskbar: unsaved text still there** ([phase16.md](version2/phase16.md), Milestone 16.3)
...
**Three windows open, one minimized** ([phase16.md](version2/phase16.md), Milestone 16.3)
...
**Dialog minimized, two windows remain** ([phase16.md](version2/phase16.md), Milestone 16.3)
...
**Two of three minimized** ([phase16.md](version2/phase16.md), Milestone 16.3)
...
**Editor restored via its taskbar entry** ([phase16.md](version2/phase16.md), Milestone 16.3)
...
**Dialog also restored, now frontmost** ([phase16.md](version2/phase16.md), Milestone 16.3)
...
**Before maximizing: normal window size, three-button titlebar** ([phase17.md](version2/phase17.md), Milestone 17.1)
...
**Maximized: fills the screen exactly down to the taskbar** ([phase17.md](version2/phase17.md), Milestone 17.1)
...
**Restored: back to the exact original position and size** ([phase17.md](version2/phase17.md), Milestone 17.1)
...
**Full desktop, screendumped 3 seconds into boot** ([phase18.md](version2/phase18.md), Milestone 18.1)
...
**File Manager opened via a real simulated click, same fast boot** ([phase18.md](version2/phase18.md), Milestone 18.1)
...
**Desktop, moments after the ring3/syscall/ELF demo ran during the same boot** ([phase19.md](version2/phase19.md), Milestones 19.1–19.3)
...
**File Manager listing the newly-bundled HELLO.ELF** ([phase19.md](version2/phase19.md), Milestone 19.3)
...
**Desktop, moments after 8 processes ran under the scheduler during the same boot** ([phase20.md](version2/phase20.md), Milestones 20.1–20.3)
...
**File Manager listing every bundled multi-process test binary** ([phase20.md](version2/phase20.md), Milestone 20.1)
...
**Before resizing** ([phase21.md](version2/phase21.md), Milestone 21.1)
The File Manager at its default 420×260 size.

![File Manager at default size](screenshots/phase21_before_resize.png)

**Enlarged by dragging the bottom-right corner** ([phase21.md](version2/phase21.md), Milestone 21.1)
...
**Shrunk back down** ([phase21.md](version2/phase21.md), Milestone 21.1)
...
**Clamped at the screen edge** ([phase21.md](version2/phase21.md), Milestone 21.1)
...
**Alt+Tab cycling through three windows, no mouse involved** ([phase21.md](version2/phase21.md), Milestone 21.2)
...
**Taskbar clock, ten seconds apart** ([phase22.md](version2/phase22.md), Milestone 22.2)
...
**F2 toggles the wallpaper** ([phase22.md](version2/phase22.md), Milestone 22.3)
...
**File Manager moved and resized, then settings restored on a fresh boot** ([phase22.md](version2/phase22.md), Milestone 22.3)
...
**Long filenames read correctly, including host-seeded ones** ([phase23.md](version2/phase23.md), Milestone 23.1)
...
**Long filenames created, renamed, and deleted through the real UI** ([phase23.md](version2/phase23.md), Milestone 23.2)
...
**Terminal: filesystem navigation and a real ring-3 process launch** ([phase24.md](version2/phase24.md), Milestone 24.1)
...
**Calculator: the milestone's own test sequence** ([phase24.md](version2/phase24.md), Milestone 24.2)
...
**Image Viewer: opened via a real File Manager double-click** ([phase24.md](version2/phase24.md), Milestone 24.3)
...
**A discoverable, 5-option wallpaper picker** ([phase-patchv2.md](version2/phase-patchv2.md), Rounds 1-2)
...
**Taskbar clock margin fixed** ([phase-patchv2.md](version2/phase-patchv2.md), Round 3)
...
**Mac/Custom wallpaper mapping fixed** ([phase-patchv2.md](version2/phase-patchv2.md), Round 4)
...
### Phase 25 — Audit 2: Critical Fixes (v3 Track A)

**A bad user-mode pointer no longer freezes the kernel** ([phase25.md](phase25.md), Milestone 25.1)
`run Badptr.Elf` deliberately calls a syscall with an unmapped pointer - the kernel now rejects it instead of page-faulting, the process exits normally with its marker code, and the desktop stays fully responsive afterward.
...
project-plan-3.md    v3 project plan (current/active): audit 2 remediation (Track A) + foundation gaps
...
phase27.md           v3 Track A, Phase 3: 10 Medium + 7 Low audit-2 fixes (Calculator sign/overflow,
                      heap backward coalescing, GOS.CFG checksum/geometry check, 11 smaller cleanups)
...
version2/            all v2 planning/completion docs, moved here after v3 planning began
  project-plan-2.md   v2 project plan: audit remediation (Track A) + new features (Track B) + Tracks C/D/E
  ...
  audit2.md           standalone, read-only flaw audit of everything v2's Tracks A-E added (28 ranked findings)
```
...
- [phase27.md](phase27.md) — Track A's third and final phase: all 10 Medium and 7 Low audit-2 findings closed (16 fixed, 1 documented as an accepted simplification); includes a symptom/diagnosis/fix writeup for a real regression a reentrancy-guard fix introduced in the window stress test, found and corrected before the phase closed
...
- [version2/phase16.md](version2/phase16.md) — Track B's second phase: window minimize and taskbar restore/focus, each with a "command to test" and a "command to see", a real heap-leak regression measurement for window teardown, and a documented test-script bug (not a kernel bug) found while verifying dynamic taskbar reordering
- [version2/phase17.md](version2/phase17.md) — Track B's third and final phase: window maximize/restore, with an exact geometry round-trip proven both numerically (a debug build logging x/y/w/h at each step) and visually — Track B is complete as of this phase
- [version2/phase18.md](version2/phase18.md) — cuts the default boot from ~75-80s to ~1s by gating the old regression-demo/stress-test sequence behind a new `make diagnostic` build, with the PIT tick count used to measure the improvement and a log-diff proving zero loss of test coverage
- [version2/phase19.md](version2/phase19.md) — Track C's first phase: ring 3 execution, an `int 0x80` syscall gate, and a minimal ELF64 loader running a real bundled binary, including a full symptom/diagnosis/fix writeup for a genuine VMM bug (page-table `PAGE_USER` bit not propagating to already-existing intermediate entries) found while testing the very first user-mode mapping
- [version2/phase20.md](version2/phase20.md) — Track C's second phase: a real preemptive scheduler with per-process page-table isolation, `spawn`/`exit`/`waitpid` syscalls, and a 5-process fairness test, including two documented bugs found during testing (a NASM label/register-name collision, and an initial test workload too fast to actually trigger preemption)
- [version2/phase21.md](version2/phase21.md) — Track D's first phase: drag-to-resize windows (with min-size and screen-edge clamping) and Alt+Tab switching, including a documented design bug (the first focus-cycling algorithm only ever toggled between 2 windows) caught by hand-tracing the logic before ever booting it
- [version2/phase22.md](version2/phase22.md) — Track D's second phase: a CMOS RTC driver, a live taskbar clock (verified against a QEMU-controlled clock), and `GOS.CFG` settings persistence (wallpaper mode + File Manager geometry) cross-checked byte-for-byte via `xxd` and confirmed end-to-end across a genuinely fresh QEMU process
- [version2/phase23.md](version2/phase23.md) — Track D's third and final phase: FAT32 VFAT long-filename read/write support, verified in both directions against `mtools`
- [version2/phase24.md](version2/phase24.md) — Track E: a kernel-mode Terminal with a genuine ring-3 `run` command, a Calculator, and an Image Viewer reusing the BMP decoder
- [version2/phase-patchv2.md](version2/phase-patchv2.md) — a post-Phase-24 patch: a discoverable desktop wallpaper picker, a taskbar clock margin fix, and a wallpaper-label mapping fix
...
- [version1/audit.md](version1/audit.md) — the original read-only, no-changes-made audit of the v1.0 kernel that Track A of v2 (Phases 12–14) fully remediated; useful as historical context for *why* those fixes existed
