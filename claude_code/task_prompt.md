### Now do Phase 16 the same way and create phase16.md in the same format as the previous phase docs. 

In phase16.md, after every milestone, include: 
...
If you find and fix a bug during testing, document it in the phase doc: the symptom, the diagnosis, what you tried that didn't work (if anything), and the actual fix. 

Update the README.md finally with the latest screenshots if there are any to show progress.
